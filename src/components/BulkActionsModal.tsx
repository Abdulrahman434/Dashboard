...
export default function BulkActionsModal({
  ...
  const handleSave = () => {
    ...
    toast.success('Settings Saved', {
      description: `All changes have been applied to ${selectedCount} terminal(s) successfully`,
      duration: 2000,
    });
    onClose();
  };
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-[20px] font-semibold text-[#16274D] font-['Poppins',sans-serif]">
                Bulk Terminal Settings
              </h2>
              <p className="text-[13px] text-[#637381] font-['Poppins',sans-serif] mt-0.5">
                Configure settings for {selectedCount} selected terminal{selectedCount !== 1 ? 's' : ''}
              </p>
            </div>
          </div>
          <button
